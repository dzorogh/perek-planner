...
| **Product** | Perekrestok catalog item for the selected store. |
...
| **Pantry item** | Spices, sauces, or staples that gate Recipe eligibility. In v1 they appear on the Shopping list by default; Sergey filters at Perekrestok order time. |
