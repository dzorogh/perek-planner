...
**Retailer-owned planning (Russia):** Perekrestok «ПП-Консьерж» — questionnaire → day-by-day ration + КБЖУ → add ingredients to Perekrestok cart for pickup/delivery ([foodretail.ru](https://foodretail.ru/news/perekryostok-zapustil-besplatniy-servis-personalnogo-pitaniya-496892), [food-helper.x5.ru](https://food-helper.x5.ru)). Store app also exposes availability checks and picker replacements ([Play Store listing](https://play.google.com/store/apps/details?id=ru.perekrestok.app)).
...
Retailer fulfillment (e.g. Perekrestok app copy): picker offers a replacement when something runs out during assembly.
