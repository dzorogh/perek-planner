# Requirements digest — perek-planner brief

Source: `briefs/brief-perek-planner-2026-07-19/` (extracted 2026-07-19)
...
- Perekrestok only @ Alabino, 92; thin store-catalog boundary for later stores
...
- **Store:** Perekrestok only; address **д. Алабино, 92**.
...
- No public Perekrestok consumer checkout API; PyPI `perekrestok-api` = unofficial RE, OK for personal catalog/prices, not ordering/guaranteed stock.
