...
**Authority:** `_bmad-output/planning-artifacts/architecture/architecture-keplo-2026-07-19/.memlog.md`  
...
| store-catalog-api | 0.2.2 | ✓ Latest PyPI (2026-02-23) | Unofficial scraper client; operational risk acknowledged in memlog |
...
| Python (sync) | ≥3.10 | ✓ Matches store-catalog-api requirement | — |
...
**Driving inputs:** PRD `prd-keplo-2026-07-19` + UX `ux-keplo-2026-07-19` (both listed in spine `sources`).
...
- **L2:** `store-catalog-api` is unofficial — memlog flagged; operational fragility is known risk, not a spine defect.
