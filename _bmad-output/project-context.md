...
- Browser Supabase client for auth/UI and Realtime (menu live sync: listen `postgres_changes` + Broadcast busy overlays); data writes + AI via server client/actions — never mutate menu rows from the browser
